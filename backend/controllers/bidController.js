...
export const placeBid = catchAsyncErrors(async (req, res, next) => {
  ...
  if (!auctionItem) {                                                    //IN THIS SECTION BID PLACEMENT STRUCTURE ALONG WITHCONDITION OF HIGHER BID THEN CURRENT BID CONDITIONS ARE DEFINED LIKE CURRENT BID ,STARTING BID 
